...
class Mappo_Reconn:
    ...
    def save_model(self, env_name, number, seed, total_steps):
        torch.save(self.actor.state_dict(), "C:/Workspace/WRJ/MACA-2D/MACA/algorithm/mappo/model/Reconn_actor_env_{}_number_{}_seed_{}_step_{}.pth".format(env_name, number, seed, int(total_steps)))

    def load_model(self, env_name, number, seed, step):
        self.actor.load_state_dict(torch.load("C:/Workspace/WRJ/MACA-2D/MACA/algorithm/mappo/model/Reconn_actor_env_{}_number_{}_seed_{}_step_{}.pth".format(env_name, number, seed, step)))
