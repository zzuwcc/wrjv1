...
def main(args):
    ...
    evaluate_reward_mean_record = np.load('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/mappo/result/evaluate_reward_mean_record_{}.npy'.format(number))
    ...
    if info['win_info'] == 'ally win':
        is_win = 1
    print('total_reward: {}, is_win: {}'.format(total_reward, is_win))
    gif_generate('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/mappo/result/render_{}.gif'.format(number))
