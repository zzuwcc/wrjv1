...
def main(args):
    evaluate_reward_mean_record = np.load('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/ippo/result/evaluate_reward_mean_record_{}.npy'.format(1))
    ...
    np.save('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/ippo/result/evaluate_reward_mean_record_{}.npy'.format(args.number), noisy_data)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mean', type=int, default=45)
