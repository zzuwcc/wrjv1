...
def plot_train_reward(args):
    evaluate_reward_mean_record = np.load('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/subtask_mappo/result/evaluate_reward_mean_record_{}.npy'.format(args.number))
    ...
    plt.savefig('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/subtask_mappo/result/CTDE_{}.png'.format(args.number),dpi=1200)
    plt.show()

    with open('C:/Workspace/WRJ/MACA-2D/MACA/algorithm/subtask_mappo/result/plot_info_{}.txt'.format(args.number), 'w') as f:
